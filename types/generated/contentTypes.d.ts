...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Dynamic content for the About Us page';
  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        ...
        'sections.partners-wrapper',
        'sections.process-wrapper',
        'sections.values-section',
        'sections.farm-wrapper',
...
export interface ApiFaqPageFaqPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configuration for the FAQ page header';
...
export interface ApiFarmPageFarmPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    environment: Schema.Attribute.Component<
      'sections.farm-environment',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiMediaCategoryMediaCategory
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    media_posts: Schema.Attribute.Relation<
      'oneToMany',
      'api::media-post.media-post'
    >;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
...
export interface ApiMediaPageMediaPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configuration for the Media Center listing page header';
    displayName: 'Media Center Page';
...
export interface ApiMediaPostMediaPost extends Struct.CollectionTypeSchema {
  collectionName: 'media_posts';
  info: {
    displayName: 'Media Post';
    pluralName: 'media-posts';
    singularName: 'media-post';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPrivacyPagePrivacyPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'sections.legal-section', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localizable: true;
        };
...
export interface ApiProductPageProductPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configuration for the Products listing page header';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accordions: Schema.Attribute.Component<'sections.accordion-item', true>;
    category: Schema.Attribute.String;
    checkpoints: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiRecipePageRecipePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configuration for the Recipes listing page header';
    displayName: 'Recipes Page';
...
export interface ApiRecipeRecipe extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ingredientsSections: Schema.Attribute.Component<
      'sections.ingredients-section',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    method: Schema.Attribute.Component<'sections.method-step', true>;
    overview: Schema.Attribute.Text;
